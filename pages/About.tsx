      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-24">
          <div className="order-2 lg:order-1">
            ...
            <h1 className="text-3xl md:text-5xl font-serif font-bold text-gray-900 mb-6 md:mb-8">Empowering Lives with Care & Innovation</h1>
          ...
          <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
            ...
            />
            <div className="absolute -bottom-6 -left-6 md:-bottom-10 md:-left-10 bg-white p-4 md:p-8 rounded-2xl md:rounded-3xl shadow-xl hidden sm:block max-w-[180px] md:max-w-[250px] border border-gray-50">
              <div className="flex items-center gap-3 md:gap-4 mb-2">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-orange-100 rounded-full flex items-center justify-center text-orange-600 font-bold text-lg md:text-xl">10+</div>
                <div className="text-gray-900 font-bold leading-tight text-sm md:text-base">Ongoing Projects</div>
              </div>
              <p className="text-gray-500 text-xs md:text-sm">Working tirelessly across Uttarakhand.</p>
            </div>
          </div>
        </div>
